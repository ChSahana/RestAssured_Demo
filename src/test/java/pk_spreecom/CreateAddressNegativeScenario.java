...
public class CreateAddressNegativeScenario {
	@Test(dataProvider = "BadAddresses", dataProviderClass = spreecomTestData.class, priority = 2)
...
//		}
	...
	@Test(dataProvider = "addressWithLabel", dataProviderClass = spreecomTestData.class, priority = 1,enabled=true)
